...
typedef tRegisteredFunction         CallbackItem;
...
*
*      tAction management for addresses @addr0, @addr1, ..., @addrN
...
/*
*  tAction Managers of all kinds and types
*/
