...
{
	TiXmlString tmp;
	TiXmlString::size_type b_len = static_cast<TiXmlString::size_type>( SIMPLEGUI_STRLEN(b) );
...
{
	TiXmlString tmp;
	TiXmlString::size_type a_len = static_cast<TiXmlString::size_type>( SIMPLEGUI_STRLEN(a) );
