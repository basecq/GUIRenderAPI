...
CColor * SElementState::GetColor( SIMPLEGUI_STRING sString )
{
...
CTexture * SElementState::GetTexture( SIMPLEGUI_STRING sString )
{
...
int SElementState::GetInt( SIMPLEGUI_STRING sString )
{
